...
describe('analyzer', () => {
	...
	describe('analyzeRepositories', () => {
		...
		it('should call onProgress callback', async () => {
			...
			const repos = [{
				id: 1, name: 'r1', full_name: 'u/r1', description: null,
				private: false, html_url: 'https://github.com/u/r1', clone_url: null,
				pushed_at: null, fork: false, archived: false, default_branch: 'main',
				language: null, stargazers_count: 0, forks_count: 0,
				open_issues_count: 0, size: 0, owner: { login: 'u' }
			}];
		...
		it('should continue processing when individual repo analysis fails', async () => {
			const mockClient = {
				request: vi.fn()
					.mockResolvedValueOnce({ data: [{ commit: { committer: { date: '2025-01-01T00:00:00Z' } } }] })
			};

			// First repo has no owner property, which will cause a TypeError
			const badRepo = {
				id: 1, name: 'fail-repo', full_name: 'u/fail-repo', description: null,
				private: false, html_url: 'https://github.com/u/fail-repo', clone_url: null,
				pushed_at: null, fork: false, archived: false, default_branch: 'main',
				language: null, stargazers_count: 0, forks_count: 0,
				open_issues_count: 0, size: 0, owner: null // null owner causes error
			};

			const goodRepo = {
				id: 2, name: 'ok-repo', full_name: 'u/ok-repo', description: null,
				private: false, html_url: 'https://github.com/u/ok-repo', clone_url: null,
				pushed_at: null, fork: false, archived: false, default_branch: 'main',
				language: null, stargazers_count: 0, forks_count: 0,
				open_issues_count: 0, size: 0, owner: { login: 'u' }
			};
