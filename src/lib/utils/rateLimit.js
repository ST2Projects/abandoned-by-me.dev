...
export const scanLimiter = createRateLimiter({ windowMs: 10 * 60 * 1000, max: 5 });

/** Config updates – 20 requests per minute */
export const configLimiter = createRateLimiter({ windowMs: 60 * 1000, max: 20 });

/** Respect button – 30 per minute per IP (covers all repos) */
export const respectLimiter = createRateLimiter({ windowMs: 60 * 1000, max: 30 });

/** Adoption toggle – 20 per minute */
export const adoptionLimiter = createRateLimiter({ windowMs: 60 * 1000, max: 20 });

/** Account deletion – 3 per hour (serious action) */
export const accountDeleteLimiter = createRateLimiter({ windowMs: 60 * 60 * 1000, max: 3 });
